...
- [x] **Integration with gdev deployment model** — How this fits into the existing qsdev plan: which phase(s) it belongs in, .mcp.json generation, Nix packaging of DevDocs/Kiwix/ZIM services, profile-driven configuration
  - Outcome: success
  - Completed: 2026-05-14
