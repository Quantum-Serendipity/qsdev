...
// SecurityConfigs returns a security-hardened ansible.cfg with GPG signature
// verification for galaxy collections.
func (m *Module) SecurityConfigs(_ ecosystem.ModuleConfig) []types.GeneratedFile {
	var b strings.Builder
	b.WriteString("# Security-hardened Ansible configuration\n")
