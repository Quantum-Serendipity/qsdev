...
// gdev-secure-devenv-bootstrap. It detects Dockerfiles, Containerfiles, and
...
const hadolintHeader = `# Hadolint configuration — generated by gdev-secure-devenv-bootstrap.
