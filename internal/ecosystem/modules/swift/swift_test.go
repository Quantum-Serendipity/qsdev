...
import (
	...
	"github.com/Quantum-Serendipity/gdev-secure-devenv-bootstrap/internal/ecosystem/modules/swift"
)
...
func TestName(t *testing.T) {
	m := newModule()
	if got := m.Name(); got != "swift" {
		t.Errorf("Name() = %q, want %q", got, "swift")
	}
}

func TestDisplayName(t *testing.T) {
	m := newModule()
	if got := m.DisplayName(); got != "Swift" {
		t.Errorf("DisplayName() = %q, want %q", got, "Swift")
	}
}
