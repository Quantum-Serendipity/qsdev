# Anthropic's Own CLAUDE.md: claude-code-action Repository
- **Source**: https://raw.githubusercontent.com/anthropics/claude-code-action/main/CLAUDE.md
- **Retrieved**: 2026-03-27
- **Significance**: This is Anthropic's own CLAUDE.md for their official GitHub Action. Shows how the team building Claude Code configures their own projects.
...
- **~60 lines** (excluding blank lines)
- **Structure**: Commands → What This Is → How It Runs → Key Concepts → Things That Will Bite You → Code Conventions
- **No @-mentions** of other files — uses inline file path references instead
- **Gotcha-focused**: "Things That Will Bite You" section is the longest, documenting non-obvious behaviors
- **Architecture-heavy**: Explains mode lifecycle, auth priority, prompt construction
- **Concise**: No code style rules, no linting details, no philosophical guidelines
- **Imperative voice**: "Don't break its public API" — direct instructions
- Follows their own advice: only includes things Claude can't infer from code alone
