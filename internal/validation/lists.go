...
func IsValidLanguage(lang string) bool {
	return slices.Contains(catalog.MustDefault().Languages(), lang)
}

// IsValidCoreLanguage checks if lang belongs to the core devenv language set.
func IsValidCoreLanguage(lang string) bool {
	return slices.Contains(catalog.MustDefault().CoreLanguages(), lang)
}

// IsValidService checks if svc is a supported service identifier.
func IsValidService(svc string) bool { return slices.Contains(catalog.MustDefault().Services(), svc) }
