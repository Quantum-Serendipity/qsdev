<!-- Source: https://github.com/biomejs/biome (root README.md) -->
<!-- Retrieved: 2026-05-15 via gh api -->
...
<div align="center">
  ...
  [open-vsx-badge]: https://img.shields.io/visual-studio-marketplace/v/biomejs.biome?label=Open%20VSX%20Registry&labelColor=374151&color=60a5fa
  [open-vsx-url]: https://open-vsx.org/extension/biomejs/biome

  Multi-language links: Hindi | English | Espanol | Francais | Traditional Chinese | Simplified Chinese | Japanese | Polish | Portuguese | Korean | Russian | Ukrainian
</div>
...
Vital, CodeRabbit, Forge42, RStudio, Pennylane, JetBrains, EGSTOCK Inc., Convex, Graphite, Kraken Tech
