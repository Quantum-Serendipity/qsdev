...
const Disclaimer = `DISCLAIMER: This report is generated automatically by qsdev and maps ` +
	...
	`qualified auditors covering organizational policies, procedures, ` +
	`physical security, personnel controls, and many other domains beyond ` +
	`the scope of a development environment tool. Use this report as ` +
	`supporting documentation for your compliance program, not as a ` +
	`substitute for professional compliance assessment.`
