...
func GenerateTeamWorkflow() string {
	...
	b.WriteString("# Generated by gdev team-report --generate-workflow\n")
	...
	// Step: Install gdev.
	b.WriteString("      - name: Install gdev\n")
	b.WriteString("        run: |\n")
	b.WriteString("          curl -sSfL https://raw.githubusercontent.com/Quantum-Serendipity/gdev/main/install.sh | sh\n")
	b.WriteString("          echo \"$HOME/.local/bin\" >> $GITHUB_PATH\n\n")

	// Step: Aggregate reports.
	b.WriteString("      - name: Aggregate posture reports\n")
	b.WriteString("        run: |\n")
	b.WriteString("          gdev team-report \\\n")
...
func GeneratePerProjectSteps() string {
	...
	b.WriteString("        run: |\n")
	b.WriteString("          gdev status --json > posture-report.json\n\n")
