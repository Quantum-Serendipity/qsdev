# DevPod — What is DevPod? (Official Documentation)
- **Source**: https://devpod.sh/docs/what-is-devpod (fetched from raw GitHub: https://raw.githubusercontent.com/loft-sh/devpod/main/docs/pages/what-is-devpod.mdx)
