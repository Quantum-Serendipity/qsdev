# Example CLAUDE.md: Hugo Blog (ArthurClune/claude-md-examples)
- **Source**: https://raw.githubusercontent.com/ArthurClune/claude-md-examples/main/hugo-CLAUDE.md
...
## Architecture
This project is a Hugo personal blog, following the standard Hugo conventions.
...
- ~30 lines, very concise
- Architecture first, then build commands, then style rules
- Uses emphasis (NEVER, ALWAYS) for critical rules
