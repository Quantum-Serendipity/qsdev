...
// gdev-secure-devenv-bootstrap. It detects Scala projects by scanning for
...
func (m *Module) SecurityConfigs(_ ecosystem.ModuleConfig) []types.GeneratedFile {
	content := `// Security plugins for sbt — generated by gdev-secure-devenv-bootstrap.
...
`
	...
	return []types.GeneratedFile{
		{
			Path:     ".gdev/sbt-security-plugins.sbt",
