...
func EvalCheckExpression(expr string, report *PostureReport) (bool, error) {
...
func evalDefense(parts []string, op, rhs string, report *PostureReport) (bool, error) {
...
func evalDependencies(parts []string, op, rhs string, report *PostureReport) (bool, error) {
...
func evalConfig(parts []string, op, rhs string, report *PostureReport) (bool, error) {
	// config.score >= <float>
...
func evalScore(parts []string, op, rhs string, report *PostureReport) (bool, error) {
	// score.total >= <float>
...
func evalTools(parts []string, op, rhs string, report *PostureReport) (bool, error) {
	// tools.<name>.enabled == true|false
