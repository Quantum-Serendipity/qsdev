// Package cpp implements the C/C++ ecosystem module for gdev-secure-devenv-bootstrap.
...
func conanSecurityConfig() types.GeneratedFile {
	...
	b.WriteString("# Generated by gdev-secure-devenv-bootstrap.\n")
...
func vcpkgSecurityConfig() types.GeneratedFile {
	var b strings.Builder
	b.WriteString("{\n")
	b.WriteString("  \"$comment\": \"Security-hardened vcpkg configuration. Generated by gdev-secure-devenv-bootstrap. Pin the baseline to a specific vcpkg commit for reproducible builds.\",\n")
